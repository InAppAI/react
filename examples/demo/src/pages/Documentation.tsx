          ...
          <section id="overview" className="docs-section">
            ...
            <div className="feature-grid">
              ...
              <div className="feature-card">
                ...
                <p>Automatic localStorage persistence across page refreshes and navigation.</p>
              </div>
              <div className="feature-card">
                <div className="feature-icon">🎭</div>
...
npm install @inappai/react
            ...
            <h3>Basic Usage</h3>
            <p>Import and use the InAppAI component in your React app:</p>
            <div className="docs-code-block">
    ...
    <div>
      ...
      />
            ...
            <div className="info-box">
              <h4>💡 Subscription ID Required</h4>
              <p>
                You need a subscription ID from InAppAI to use the component. Get yours at the
                InAppAI dashboard. Pass it as the <code>subscriptionId</code> prop.
              </p>
            </div>
          </section>
          ...
          <section id="display-modes" className="docs-section">
            <h2>Display Modes</h2>
            <p>InAppAI supports 5 different display modes to fit your application layout:</p>
...
AI: [Calls updatePriority({ taskId: "123", priority: "high" })]
    "Updated the task to high priority."`}
          ...
          <section id="persistence" className="docs-section">
            ...
            <p>
              Use the <code>conversationId</code> prop to automatically save and restore conversations
              using localStorage. Messages persist across page refreshes and navigation.
            </p>

            <h3>Single Persistent Assistant</h3>
            <p>Use the same ID across your entire app for one continuous conversation:</p>
            <div className="docs-code-block">
              <div className="code-language">tsx</div>
{`<InAppAI
  endpoint="https://api.inappai.com/api/your-id"
...
/>`}
            ...
            <h3>Page-Specific Conversations</h3>
            <p>Use different IDs per page for isolated conversations:</p>
            <div className="docs-code-block">
              <div className="code-language">tsx</div>
{`// Support page
...
<InAppAI conversationId="settings-help" />`}
            ...
            <h3>User-Specific Conversations</h3>
            <p>Include user ID for per-user persistence:</p>
            <div className="docs-code-block">
              <div className="code-language">tsx</div>
{`<InAppAI conversationId={\`user-\${userId}-assistant\`} />`}
            ...
            <div className="info-box">
              <h4>💡 How It Works</h4>
              <p>
                Messages are saved to localStorage with the key
                <code>inappai_conversation_{'{'}conversationId{'}'}</code>.
                When the component mounts, previous messages are automatically restored.
              </p>
            </div>
          </section>
            ...
            <table className="params-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Your backend API endpoint including subscription ID</td>
                </tr>
                <tr>
                  <td><span className="param-name">displayMode</span></td>
                  <td><span className="param-type">string</span></td>
                  <td><span className="param-optional">Optional</span></td>
                  <td>'popup' | 'sidebar-left' | 'sidebar-right' | 'panel-left' | 'panel-right'</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><span className="param-type">string</span></td>
                  <td><span className="param-optional">Optional</span></td>
                  <td>Unique ID for localStorage persistence</td>
                </tr>
                <tr>
