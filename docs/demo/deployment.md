...
The demo is deployed to: **https://react-demo.inapppai.com**

## Configuration Files

### 1. CNAME File
- **Location**: `public/CNAME`
- **Content**: `react-demo.inapppai.com`
...
3. Under **Custom domain**, enter: `react-demo.inapppai.com`
...
6. Site becomes available at https://react-demo.inapppai.com
